<table class="table table-bordered table-striped" id="carreras-table">
    <thead>
        <th>Nivel Escolar</th>
        <th>Clave Oficial</th>
    ...
    @foreach($carreras as $carrera)
        <tr>
            ...
            <td>{!! $carrera->titulo_entrega !!}</td>
            <td>{!! $carrera->clave !!}</td>
            <td>{!! $carrera->nivel !!}</td>
            <td>{!! $carrera->consecturivo_carrera !!}</td>
            <td>{!! $carrera->area_academica !!}</td>
            <td>
