...
<div class="form-group">
    ...
    <p>{!! $aspiranteGeneral->folio_solicitud !!}</p>
</div>

<!-- Periodo Field -->
<div class="form-group">
    {!! Form::label('periodo', 'Periodo:') !!}
    <p>{!! $aspiranteGeneral->periodo !!}</p>
</div>
...
<div class="form-group">
    ...
    <p>{!! $aspiranteGeneral->nombres_aspirante !!}</p>
</div>
...
<div class="form-group">
    ...
    <p>{!! $aspiranteGeneral->vive_padre !!}</p>
</div>
...
<div class="form-group">
    ...
    <p>{!! $aspiranteGeneral->vive_madre !!}</p>
</div>
