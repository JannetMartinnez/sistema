...
<div class="col-md-10">
        ...
        <div class="panel-body">
            {!! Form::open(['route' => 'aspiranteGenerals.store']) !!}
                ...
                <div class="form-group col-sm-4">
                    ...
                    {!! Form::text('correo_elect_dom_actual', null, ['class' => 'form-control','placeholder' => 'Correo elctrónico']) !!}
                </div>
                <!-- Correo Elect Dom Actual Field -->
                <div class="form-group col-sm-4">
                ...
                <div class="form-group col-sm-4" style="clear: both">
                    ...
                    {!! Form::text('numero_seguro_social', null, ['class' => 'form-control','placeholder' => 'Número S.S.']) !!}
                </div>
                <!-- Numero seguro social Dom Actual Field -->
                <div class="form-group col-sm-4">
    ...
    <aside class="col-md-2">
        ...
        El correo electrónico es requerido ya que en el vas a recibir tu usuario y contraseña, referencia bancaria y ficha de exámen ingreso.
