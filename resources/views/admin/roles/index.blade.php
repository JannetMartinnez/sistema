...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading text-center">
            <i class="fa fa-list-alt" aria-hidden="true"></i> <strong>@yield('title')</strong><a href="{{ route('admin.roles.create') }}" class="btn btn-itslp pull-right">@lang('global.app_add_new')</a>
        </div>
