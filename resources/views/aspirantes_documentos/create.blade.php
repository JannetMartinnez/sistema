@extends('layouts.app')
@section('title','Aspirante Documentos')
@section('content')
 ...
 <div class="col-md-10">
    <div class="panel panel-default">
       <div class="panel-heading text-center">
            <a href="{{ route('aspirantesDocumentos.index') }}" class="btn_reg pull-left"  data-toggle="tooltip" data-placement="right" title="Regresar"><i class="fa fa-arrow-circle-left"></i></a>
            <strong><i class="fa fa-plus" aria-hidden="true"></i> @yield('title')</strong>
        </div>
        <div class="panel-body">

                        {!! Form::open(array('route' => 'aspirantesDocumentos.store', 'files'=>true)) !!}


                        @include('aspirantes_documentos.fields')
